...
- **New to Fastify?** Start with `plugins.md` → `routes.md` → `zod-type-provider.md` (this repo) or `schemas.md` (generic JSON Schema / TypeBox)
...
- [rules/zod-type-provider.md](rules/zod-type-provider.md) - Zod 4 + fastify-type-provider-zod (validation, serialization, Swagger/OpenAPI)
- [rules/schemas.md](rules/schemas.md) - JSON Schema validation (TypeBox; generic reference)
